...
// ya esta solo esta mal los mensakjes
import java.util.*;
        ...
        listPortales.forEach(portales -> {
            ...
            while (!stack.isEmpty()) {
                ...
                if (porVol.isPresent()) {
                    ...
                    final String destinoEncontrado3 = "Iniciamos en el MAPA "
                    ...
                    resultado.add(destinoEncontrado3);
                } else {
                    ...
                    listPortales2.forEach(forOtro -> {
                        if (!visitados.contains(forOtro.getNamePortal() + "-" + forOtro.getIrZona() + "-" + forOtro.getAparecerPortal())) {
                            ...
                            while (!stackNuevo.isEmpty()) {
                                ...
                                if(portalesNueva==null ){
                                    portalesNueva =new ArrayList<>();
                                }
                                ...
                                if (porVolNuevo.isPresent()) {
                                    ...
                                    final String destinoEncontrado2 = "Iniciamos en el MAPA "
                                            .concat(mapaOrigen).concat(" zona ").concat(zonaOrigen + " ")
                                    ...
                                    resultado.add(destinoEncontrado2);
                                }
                            }
                        }
                    });
